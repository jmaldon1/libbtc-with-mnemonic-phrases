...
void test_tool()
{
    ...
    char privkeyhex[100];
    char mnemonic[256];
    u_assert_int_eq(gen_privatekey(&btc_chainparams_main, privkeywif, privkeywiflen, NULL, mnemonic), true);
    u_assert_int_eq(gen_privatekey(&btc_chainparams_main, privkeywif, privkeywiflen, privkeyhex, mnemonic), true);
